...
def main():
    image = cv2.imread('/home/xuhang/dataset/mono+color/left/16#_10lux_color.bmp')
    enhanced_image = enhance_image_exposure(image, gamma=0.6, lambda_=0.15, dual=True,
                                            sigma=3, bc=1, bs=1, be=1, eps=1e-3)
    cv2.imwrite('lime_out2.png', enhanced_image)

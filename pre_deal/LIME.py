...
class LIME:
    def __init__(self, iterations=10, alpha=2, rho=2, gamma=0.3, strategy=2, *args, **kwargs):
...
# lime = LIME()
# lime.load('/home/xuhang/dataset/mono+color/left/16#_10lux_color.bmp')
# lime.enhance()
# plt.imsave('lime_out.png', lime.R)
